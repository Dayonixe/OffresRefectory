...
- Enter the topic `prawse-refectory-alerts-{city}` (for example `prawse-refectory-alerts-toulouse`)
- Leave `Use another server` unchecked
- Leave `Instant delivery in doze mode` unchecked
- Click on `Subscribe`

You will now receive all notifications about new general offers and offers in your city!
